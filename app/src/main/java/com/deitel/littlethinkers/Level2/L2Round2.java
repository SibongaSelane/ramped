...
import com.deitel.littlethinkers.Level1.L1Round3;
import com.deitel.littlethinkers.R;

public class L2Round2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l2_round2);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mButtonChoice1.getText() == "1") {
                    Toast.makeText(L2Round2.this, "Well done!", Toast.LENGTH_SHORT).show();
                    // Intent loginInt = new Intent(Level1_Activity.this, roundTwoActivity.class);
                    //startActivity(loginInt);
                } else {
                    AlertDialog.Builder builder = new AlertDialog.Builder(L2Round2.this);
        ...
        mButtonChoice3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent loginInt = new Intent(L2Round2.this, L2Round3.class);
                        startActivity(loginInt);
                    }
                });
                builder.show();
    ...
    public void BackButton() {
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(L2Round2.this, ActivityPage.class);
                startActivity(back);
            }
        });
    }
