...
public class Level2Activity extends AppCompatActivity {
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mButtonChoice1.getText() == "1") {
                    Toast.makeText(Level2Activity.this, "Well done!", Toast.LENGTH_SHORT).show();
        ...
        mButtonChoice2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent next = new Intent(Level2Activity.this, L2Round2.class);
                        startActivity(next);
                    }
                });
                builder.show();
    ...
    public void BackButton() {
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(Level2Activity.this, ActivityPage.class);
                startActivity(back);
            }
        });
    }
