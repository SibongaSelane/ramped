package com.deitel.littlethinkers.SlidingPuzzles;
...
public class SlidingPuzzle1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sliding_puzzle1);
    ...
    private void Hint() {
        imageHint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(SlidingPuzzle1.this);
    ...
    private static void display(Context context) {
        ...
        for (int i = 0; i < tileList.length; i++) {
            ...
            if (tileList[i].equals("0"))
                button.setBackgroundResource(R.drawable.mickey1);
            else if (tileList[i].equals("1"))
                button.setBackgroundResource(R.drawable.mickey2);
            else if (tileList[i].equals("2"))
                button.setBackgroundResource(R.drawable.mickey3);
            else if (tileList[i].equals("3"))
                button.setBackgroundResource(R.drawable.mickey4);
