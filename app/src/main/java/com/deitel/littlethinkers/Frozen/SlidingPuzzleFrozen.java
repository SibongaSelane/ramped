...
public class SlidingPuzzleFrozen extends AppCompatActivity {
    ...
    private static GridViewFrozen mGridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sliding_puzzle_frozen);
    ...
    private void Hint() {
        imageHint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(SlidingPuzzleFrozen.this);
    ...
    private void init() {
        mGridView = (GridViewFrozen) findViewById(R.id.gridFrozen);
    ...
    private static void display(Context context) {
        ...
        for (int i = 0; i < tileList.length; i++) {
            ...
            if (tileList[i].equals("0"))
                button.setBackgroundResource(R.drawable.frozen1);
            else if (tileList[i].equals("1"))
                button.setBackgroundResource(R.drawable.frozen2);
            else if (tileList[i].equals("2"))
                button.setBackgroundResource(R.drawable.frozen3);
            else if (tileList[i].equals("3"))
                button.setBackgroundResource(R.drawable.frozen4);
