...
public class L4Round2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l4_round2);
    ...
    public void choiceOne() {
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(L4Round2.this);
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent loginInt = new Intent(L4Round2.this, L4Round3.class);
        ...
        mButtonChoice2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mButtonChoice3.getText() == "1") {
                    Toast.makeText(L4Round2.this, "Well done!", Toast.LENGTH_SHORT).show();
    ...
    public void BackButton() {
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(L4Round2.this, ActivityPage.class);
                startActivity(back);
            }
        });
    }
