...
public class L4Round3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l4_round3);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mButtonChoice1.getText() == "1") {
                    Toast.makeText(L4Round3.this, "Well done!", Toast.LENGTH_SHORT).show();
                    // Intent loginInt = new Intent(Level1_Activity.this, roundTwoActivity.class);
                    //startActivity(loginInt);
                } else {
                    AlertDialog.Builder builder = new AlertDialog.Builder(L4Round3.this);
    ...
    public void choiceTwo() {
        ...
        mButtonChoice2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Well done. You have completed all the levels");
    ...
    public void BackButton() {
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent back = new Intent(L4Round3.this, ActivityPage.class);
                startActivity(back);
            }
        });
    }
